...
<html class="no-js" lang="fr">
	<head>
		<title>Le Fournil d’Artigues > Macaron</title>
	...
	<body class="page">
		...
		<div class="row">
			...
			<h2><a href="nos-produits.php">Nos produits</a> > Macaron</h2>
			
			<div class="large-4 medium-4 small-12 columns liste-produits">
				<a href="#" class="active" title="Macaron">Macaron</a>
				<a href="#" title="Macaron">Macaron</a>
				<a href="#" title="Macaron">Macaron</a>
				<a href="#" title="Macaron">Macaron</a>
			</div>
			<div class="large-8 medium-8 small-12 columns fiche">
				...
				<ul class="parfum">
					...
					<li>Pomme</li>
					<li>Abricot</li>
					<li>Fruit des bois</li>
					<li>Framboises</li>
				</ul>
				<p><img src="img/produit-macaron.jpg" alt="Macaron" title="Macaron" /></p>
			</div>
		</div>
		<!-- End Content -->
