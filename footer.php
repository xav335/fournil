		...
		<div class="row fullwidth footer">
			<div class="row">
				<form id="form_news" method="post" action="#" class="newsletter">
					...
					<div class="large-12 columns">Abonnez-vous à notre newsletter <input type="email" name="email_news" id="email_news" placeholder="saisissez votre e-mail" /><input type="submit" value="OK" /></div>
				</form>
			</div>
